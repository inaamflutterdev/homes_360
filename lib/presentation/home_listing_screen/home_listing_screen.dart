...
import 'provider/home_listing_provider.dart';

class HomeListingScreen extends StatefulWidget {
  const HomeListingScreen({Key? key}) : super(key: key);

  @override
  HomeListingScreenState createState() => HomeListingScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => HomeListingProvider(), child: HomeListingScreen());
  }
}

// ignore_for_file: must_be_immutable
class HomeListingScreenState extends State<HomeListingScreen> {
