...
import 'provider/notification_empty_states_provider.dart';

class NotificationEmptyStatesScreen extends StatefulWidget {
  const NotificationEmptyStatesScreen({Key? key}) : super(key: key);

  @override
  NotificationEmptyStatesScreenState createState() =>
      NotificationEmptyStatesScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => NotificationEmptyStatesProvider(),
        child: NotificationEmptyStatesScreen());
  }
}

class NotificationEmptyStatesScreenState
    extends State<NotificationEmptyStatesScreen> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: Container(
                ...
                padding: EdgeInsets.only(left: 41.h, top: 100.v, right: 41.h),
                child: Column(children: [
                  CustomImageView(
                      imagePath: ImageConstant.imgMailNotification,
                      height: 204.v,
                      width: 255.h),
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarSubtitleTwo(text: "lbl_notification".tr),
