...
import 'provider/recently_views_provider.dart';

class RecentlyViewsScreen extends StatefulWidget {
  const RecentlyViewsScreen({Key? key}) : super(key: key);

  @override
  RecentlyViewsScreenState createState() => RecentlyViewsScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => RecentlyViewsProvider(),
        child: RecentlyViewsScreen());
  }
}

class RecentlyViewsScreenState extends State<RecentlyViewsScreen> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return SafeArea(
        child: Scaffold(
            ...
            bottomNavigationBar: Padding(
                ...
                child: _buildGoldenMeadows1(context,
                    goldenMeadows: "lbl_golden_meadows".tr,
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarSubtitleTwo(text: "lbl_recently_viewed2".tr),
