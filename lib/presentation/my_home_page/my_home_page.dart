...
class MyHomePage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => MyHomeProvider(), child: MyHomePage());
  }
}
...
class MyHomePageState extends State<MyHomePage> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarSubtitleTwo(text: "lbl_my_home".tr),
  ...
  Widget _buildPropertyList(BuildContext context) {
    return Consumer<MyHomeProvider>(builder: (context, provider, child) {
      return ListView.separated(
          ...
          itemCount: provider.myHomeModelObj.propertylistItemList.length,
          itemBuilder: (context, index) {
            PropertylistItemModel model =
                provider.myHomeModelObj.propertylistItemList[index];
            return PropertylistItemWidget(model, onTapProperty: () {
